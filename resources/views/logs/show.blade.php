...
@php
    $logI18n = [
        ...
        'searchResults' => __('app.search_results'),
        ...
        'runningAction' => __('app.running_action'),
        'actionDone' => __('app.action_done'),
        'actionError' => __('app.action_error'),
        'actionSuccessTitle' => __('app.action_success_title'),
        'pullingCode' => __('app.pulling_code'),
        'pullSuccess' => __('app.pull_success'),
        'pullError' => __('app.pull_error'),
    ];
@endphp
<script id="log-i18n" type="application/json">{!! json_encode($logI18n, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) !!}</script>
<script>
